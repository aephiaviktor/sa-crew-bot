...
export type CrewBidBotStatus = {
  ...
  currentOrderTraitsLabel: string;
...
export class CrewBidBot {
  ...
  async getStatus(): Promise<CrewBidBotStatus> {
    ...
    return {
      ...
      currentOrderTraitsLabel: formatAttributesLabel(this.state.activeAttributes),
    ...
    return [
      {
        ...
        traitsLabel: formatAttributesLabel(this.state.activeAttributes),
